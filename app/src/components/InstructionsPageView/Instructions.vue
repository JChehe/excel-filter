<template>
	<div class="content">
		...
		<table class="table">
			<tr>
				<th>大于（或等于）</th>
				<td>对数字和字母进行大于（或等于）比较操作，列的值若大于指定值就保留该行数据。其中字母是根据 <a target="_blank" href="http://tool.oschina.net/commons?type=4">ASCII表</a> 进行比较（如：a > A）</td>
			</tr>
			<tr>
				<th>小于（或等于）</th>
				<td>与【大于（或等于）】类似</td>
		...
		<!-- 2.4 -->
		<h4>联系</h4>
		<p>如遇软件使用上的问题，请联系凹凸实验室——刘健超（邮箱：liujianchao1@jd.com）</p>
	</div>
